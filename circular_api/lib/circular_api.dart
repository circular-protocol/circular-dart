...
class CircularApi {
  // VARIABLES
  String _NAG_KEY = '';
  String _NAG_URL = 'https://nag.circularlabs.io/NAG.php?cep=';
  String _version = '1.0.88';
  String _package_version = '0.0.1';

  // SETTERS AND GETTERS

  void set nagKey(String key) {
    _NAG_KEY = key;
  }

  void set nagUrl(String url) {
    _NAG_URL = url;
  }

  String get nagKey => _NAG_KEY;
  String get nagUrl => _NAG_URL;
  String get version => _version;
  String get packageVersion => _package_version;
  ...
  **/
  String signMessage(String plainMessage, String privateKey) {
    ...
    // Convert the signature to IEEE1363 format because the signature generated by the pointycastle library is in DER format
    Uint8List signatureIEEEP1363 = _convertToIEEE1363(signature.r, signature.s);

    // Return the signature in hex format
    return _uint8ListToHex(signatureIEEEP1363);
  }
  ...
  **/
  bool verifySignature(String publicKey, String message, String signature) {
    ...
    if (signature.length != 128) {
      _throwError("Invalid signature length");
    }
    ...
    ECSignature ecsignature = ECSignature(
        ...
        BigInt.parse(signature.substring(64), radix: 16));
  ...
  **/
  Future<Map<String, dynamic>> checkWallet(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_CheckWallet_');
  ...
  **/
  Future<Map<String, dynamic>> getWallet(
      String blockchain, String address) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetWallet_');
  ...
  **/
  Future<Map<String, dynamic>> getLatestTransaction(
      String blockchain, String address) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetLatestTransactions_');
  ...
  **/
  Future<Map<String, dynamic>> getWalletBalance(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_GetWalletBalance_');
  ...
  **/
  Future<dynamic> getWalletNonce(String blockchain, String address) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetWalletNonce_');
  ...
  */
  Future<Map<String, dynamic>> testContract(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_TestContract_');
  ...
  **/
  Future<Map<String, dynamic>> callContract(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_CallContract_');
  ...
  **/
  Future<dynamic> getDomain(String blockchain, String name) async {
    final url = Uri.parse(_NAG_URL + 'Circular_ResolveDomain_');
  ...
  **/
  Future<dynamic> getAssetList(String blockchain) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetAssetList_');
  ...
  **/
  Future<dynamic> getAsset(String blockchain, String name) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetAsset_');
  ...
  **/
  Future<dynamic> getAssetSupply(String blockchain, String name) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetAssetSupply_');
  ...
  **/
  Future<dynamic> getVoucher(String blockchain, String code) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetVoucher_');
  ...
  **/
  Future<dynamic> getBlockRange(String blockchain, int start, int end) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetBlockRange_');
  ...
  **/
  Future<dynamic> getBlock(String blockchain, int blockNumber) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetBlock_');
  ...
  **/
  Future<dynamic> getBlockCount(String blockchain) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetBlockHeight_');
  ...
  **/
  Future<dynamic> getAnalytics(String blockchain) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetAnalytics_');
  ...
  **/
  Future<dynamic> getBlockchains() async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetBlockchains_');
  ...
  */
  Future<dynamic> getPendingTransaction(String blockchain, String TxID) async {
    final url = Uri.parse(_NAG_URL + 'Circular_GetPendingTransaction_');
  ...
  **/
  ...
  Future<dynamic> getTransactionByID(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_GetTransactionbyID_');
  ...
  **/
  Future<dynamic> getTransactionByNode(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_GetTransactionbyNode_');
  ...
  **/
  Future<dynamic> getTransactionByAddress(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_GetTransactionbyAddress_');
  ...
  **/
  Future<dynamic> getTransactionByDate(String blockchain, String address,
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_GetTransactionbyDate_');
  ...
  **/
  Future<dynamic> sendTransaction(
    ...
    final url = Uri.parse(_NAG_URL + 'Circular_AddTransaction_');
